 ...
 * 
 */
public class FW_A2_ATAND extends DFD__FunktionWork {

	// *** Vorbelegung. Muss überschrieben werden
	// ************************************
	// Sortierung innerhalb der Gruppe
	public static final int sortierung = 43;
	// Gruppe, in die die Funktioon eingeordnet wird
	public static final String gruppe = "Zahlen-2";

	// Name in der Auswahl
	public static final String bezeichnung = "arcTan-D(x)";
	...
	public FW_A2_ATAND() {
		anzeige = "arcTan($0$)";
		tabellenkalkulatorString = "ARCTAN(($0$)*180 // PI()";
		...
		ausgangsbezeichnung = "ArcusTangens-Grad";
	}
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		double d_tmp = Math.toDegrees(Math.atan(tmp.toDouble()));
