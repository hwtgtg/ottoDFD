 ...
 * 
 */
public class FW_A2_COSD extends DFD__FunktionWork {
	...
	// Name in der Auswahl
	public static final String bezeichnung = "cos-D(x)";
	...
	public FW_A2_COSD() {
		anzeige = "cos-D($0$)" ;
		tabellenkalkulatorString = "COS(($0$) * PI() // 180)";
		...
		ausgangsbezeichnung = "Cosinus-Grad";
	}
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		double d_tmp = Math.cos(Math.toRadians(tmp.toDouble()));
