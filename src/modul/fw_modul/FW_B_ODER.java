 ...
 * 
 */
public class FW_B_ODER extends DFD__FunktionWork {
	...
	// Name in der Auswahl
	public static final String bezeichnung = "a ODER b";;
	...
	public FW_B_ODER() {
		anzeige = "$0$ ODER $1$" ;
		tabellenkalkulatorString = "ODER(($0$) ; ($1$))";
