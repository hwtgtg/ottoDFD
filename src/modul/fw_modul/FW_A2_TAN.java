 ...
 * 
 */
public class FW_A2_TAN extends DFD__FunktionWork {
	...
	// Name in der Auswahl
	public static final String bezeichnung = "tan(x)";
	...
	public FW_A2_TAN() {
		anzeige = "tan($0$)" ;
		tabellenkalkulatorString = "TAN($0$)";
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		double d_tmp = Math.tan(tmp.toDouble());
