 ...
 * 
 */
public class FW_AV_KleinerGleich_Null extends DFD__FunktionWork {

	// *** Vorbelegung. Muss überschrieben werden
	// ************************************
	// Sortierung innerhalb der Gruppe
	public static final int sortierung = 07;
	 ...
	 * 
	 */
	public FW_AV_KleinerGleich_Null() {
		anzeige = "$0$ <= 0";
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		Boolean b_erg = tmp.istKleinerNull() || tmp.istGleichNull();
