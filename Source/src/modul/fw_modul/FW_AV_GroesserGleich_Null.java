 ...
 * 
 */
public class FW_AV_GroesserGleich_Null extends DFD__FunktionWork {

	// *** Vorbelegung. Muss überschrieben werden
	// ************************************
	// Sortierung innerhalb der Gruppe
	public static final int sortierung = 9;
	 ...
	 * 
	 */
	public FW_AV_GroesserGleich_Null() {
		anzeige = "$0$ >= 0";
		...
		ausgangsbezeichnung = "GrößerGleich 0";
	}
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		Boolean b_erg = tmp.istGleichNull() || tmp.istGroesserNull();
