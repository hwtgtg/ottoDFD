 ...
 * 
 */
public class FW_AV_KleinerGleich extends DFD__FunktionWork {
	...
	public DFD__Daten funktionBerechnen(DFD__Daten[] datenAmEingang) {
		...
		Boolean b_erg = tmp.istKleiner(datenAmEingang[1].getDezimal()) || tmp.istGleich(datenAmEingang[1].getDezimal());
