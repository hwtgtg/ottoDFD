...
public class Zoom_Ausgabe extends Ausgabe implements  Zoom__IModul{

	Zoom__FunktionTool zoom;

	// Klassenfabrik
	public static Zoom_Ausgabe getZoomAusgabe(IContainer behaelter, String neuerText, int neuesX, int neuesY,
		...
		Zoom_Ausgabe ausgabe = new Zoom_Ausgabe(zoom, behaelter, neuerText, neuesX, neuesY, neueBreite, neueHoehe);
		return ausgabe;
	}

	// Konstruktor, wird nur über Fabrik aufgerufen
	protected Zoom_Ausgabe(Zoom__FunktionTool zoom, IContainer behaelter, String neuerText, int neuesX, int neuesY,
			int neueBreite, int neueHoehe) {
