 ...
 */
public class JPMausBehaelter implements jtoolbox.IContainer, jtoolbox.IComponente {
	...
	protected CJPMausBehaelter	obj;
	 ...
	 * @param neueHoehe
	 */
	public JPMausBehaelter(int neueBreite, int neueHoehe) {
	 ...
	 * @param neueHoehe
	 */
	public JPMausBehaelter(int neuesX, int neuesY, int neueBreite, int neueHoehe) {
	 ...
	 * @param behaelter
	 */
	public JPMausBehaelter(IContainer behaelter) {
	 ...
	 * @param neueHoehe
	 */
	public JPMausBehaelter(IContainer behaelter, int neuesX, int neuesY,
...
<pre>
	...
	public void setzeAlleMausereignisse() {
		obj.setMouseAction((1 << JPMausBehaelter.CLICK)
				| (1 << JPMausBehaelter.PRESS) | (1 << JPMausBehaelter.RELEASE)
				| (1 << JPMausBehaelter.ENTER) | (1 << JPMausBehaelter.EXIT)
				| (1 << JPMausBehaelter.DRAGGED) | (1 << JPMausBehaelter.MOVED)
				| (1 << JPMausBehaelter.WHEEL));
	}
